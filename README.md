...
- 等级复用活跃成长规则：每天基础 1 天，含缓存 Token 达到 10K / 100K / 500K / 2M，分别加速 0.25 / 0.5 / 0.75 / 1 天，只取最高档。Lv.N 累计需 N² + 4N 天，以星星、月亮、太阳、皇冠显示；进度条显示本级已积累天数 / 本级所需天数，升级时归零。
...
- Token 统计与趋势均含缓存；今日活跃度显示今日总 Token / 2M 及今日加速天数。fork、子 Agent 继承历史和重复 token 事件会去重。
