...
QQ 模式右侧的“个人资料”显示昵称、头像、状态、签名和本机 Token 统计，与保留原生内容的“chat详情”并列。两个窗口可以分别收起，整列支持滚动。等级复用活跃成长规则：每天基础 1 天，含缓存 Token 达到 10K / 100K / 500K / 2M，分别加速 0.25 / 0.5 / 0.75 / 1 天，只取最高档。达到 Lv.N 累计需要 N² + 4N 天；进度条显示本级已积累天数 / 本级所需天数，达到新等级时归零。今日活跃度显示今日总 Token / 2M 及今日加速天数。
